    ...
    <>
      ...
      <section className="relative h-[100svh] min-h-[600px] w-full overflow-hidden bg-ink">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 40%, oklch(0.92 0.006 80 / 0.12) 0%, transparent 55%)",
          }}
        />
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
          <div className="rise rise-2 relative">
            <div className="absolute inset-0 -m-8 rounded-full blur-3xl opacity-50"
              style={{ background: "radial-gradient(circle, oklch(0.92 0.006 80 / 0.25), transparent 70%)" }}
            />
            <div
              className="relative px-10 py-6 border border-silver/30"
              style={{
                background: "oklch(0.08 0.002 270 / 0.4)",
                backdropFilter: "blur(20px)",
                WebkitBackdropFilter: "blur(20px)",
              }}
            >
              <div className="text-[10px] uppercase tracking-[0.5em] text-silver/70 mb-3">
                Productora invitada
              </div>
              <div className="font-display text-6xl md:text-8xl silver-text tracking-tight">
                LEVELS
              </div>
            </div>
          </div>
          ...
          <div className="rise rise-3 mt-8 flex items-center gap-6 opacity-80">
            ...
            <span className="text-silver/60 font-serif text-3xl">×</span>
            <img src={levelsLogo} alt="Levels" className="h-12 w-auto" />
          </div>

          <h1 className="rise rise-3 mt-6 font-display silver-text text-[clamp(2.25rem,6vw,5rem)] text-balance max-w-4xl">
            Fest <span className="italic font-light">Sevilla</span>
          </h1>

          <p className="rise rise-3 mt-6 max-w-2xl text-balance font-serif italic text-base md:text-xl text-silver/85">
            La convergencia del diseño, el espacio y la cultura electrónica internacional.
          </p>

          <div className="rise rise-4 absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 text-[10px] uppercase tracking-[0.4em] text-silver/70">
            <span>Descubrir</span>
          ...
          <Reveal>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
              <div className="lg:col-span-5">
                ...
                <h2 className="font-display text-4xl md:text-5xl lg:text-6xl silver-text text-balance">
            ...
            {gallery.map((g, i) => (
              <Reveal key={i} delay={i * 100}>
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 text-[10px] uppercase tracking-[0.32em] text-silver/80 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    {g.alt}
                  </div>
                </div>
              </Reveal>
        ...
        <div className="mx-auto max-w-[1600px] px-6 md:px-12">
          <Reveal>
            <div className="text-center">
              ...
              <h2 className="font-display text-4xl md:text-6xl silver-text text-balance">
          ...
          <Reveal delay={200}>
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-px bg-border">
              {partners.map((p, i) => (
                <div
                  key={i}
                  className="aspect-[3/2] bg-ink flex items-center justify-center"
                >
                  <div className="font-serif italic text-sm text-silver/30 tracking-wide">
                    {p}
                  </div>
                </div>
              ))}
            </div>
            <div className="mt-10 text-center text-[10px] uppercase tracking-[0.4em] text-silver/40">
