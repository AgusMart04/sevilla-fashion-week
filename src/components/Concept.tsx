...
export function Concept() {
  ...
  return (
    <section id="concepto" className="relative bg-background py-32 md:py-48">
          ...
          <div className="lg:col-span-5">
            <Reveal>
              <div className="sticky top-32">
                ...
                <h2 className="font-display text-5xl md:text-6xl lg:text-7xl text-balance silver-text">
                ...
                <div className="relative mt-12">
                  ...
                  >
                    <div>
                      <div className="flex items-center gap-3 text-[10px] uppercase tracking-[0.4em] mb-4">
                        <span className="h-px w-8 bg-silver" />
                        <span className="text-silver-bright">Una plataforma internacional</span>
                      </div>
                      <p>
                    ...
                    <div>
                      <div className="flex items-center gap-3 text-[10px] uppercase tracking-[0.4em] mb-4">
                        <span className="h-px w-8 bg-silver" />
                        <span className="text-silver-bright">Más que desfiles</span>
                      </div>
                      <p>
                    ...
                    <div>
                      <div className="flex items-center gap-3 text-[10px] uppercase tracking-[0.4em] mb-4">
                        <span className="h-px w-8 bg-silver" />
                        <span className="text-silver-bright">El escenario perfecto</span>
                      </div>
                      <p>
                  ...
                  {!expanded && (
                    <div className="md:hidden absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-background to-transparent pointer-events-none" />
                  )}
                </div>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-px bg-border">
              {[
                ...
                <Reveal key={it.k} delay={300 + i * 120}>
                  <div className="group bg-background p-8 transition-colors duration-500 hover:bg-card">
